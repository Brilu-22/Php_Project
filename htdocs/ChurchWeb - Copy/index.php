...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/png" href="assets/images/slogo.svg"> 
	</head>
<body>
<main class="twt-main">
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="<?php echo BASE_URL . "/assets/images/slogo.png"; ?>" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <span class="front-para">The Space of Religion.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2024 - Selah</li>
                    <li style="color:#8D5F3E;" ><b>-Lebogang Hlongwane -</b></li>
                </ul>
            </footer>
        </main>
